      ...
      <div className="flex w-full flex-col overflow-y-auto lg:w-1/2" style={{ background: "hsl(var(--background))" }}>
        <div className="mx-auto flex w-full max-w-[400px] flex-1 flex-col justify-center px-8 py-10">
          ...
          <p className="mb-8 text-sm text-muted-foreground">
            Sign in to continue improving your presentations.
          </p>
          ...
          >
            ...
            <div className="flex items-center justify-between">
              ...
              <a href="/forgot-password" className="text-sm font-medium text-primary transition-colors duration-200 hover:text-primary/80 hover:underline">
                Forgot password?
              </a>
            </div>
          ...
          <p className="mt-8 text-center text-sm text-muted-foreground">
            ...
            <Link href="/signup" className="font-semibold text-primary transition-colors duration-200 hover:text-primary/80 hover:underline">
              Create Account
            </Link>
          </p>
        </div>
